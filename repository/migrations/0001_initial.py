# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-03-31 15:41
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('device_type_id', models.IntegerField(choices=[(1, '服务器-硬件'), (2, '服务器-虚拟机'), (3, '交换机'), (4, '防火墙')], default=1, verbose_name='资产类型')),
                ('device_status_id', models.IntegerField(choices=[(1, '上架'), (2, '在线'), (3, '离线'), (4, '下架')], default=1, verbose_name='资产状态')),
                ...
                ('latest_date', models.DateField(blank=True, null=True, verbose_name='最后更新时间')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pd_type', models.CharField(max_length=64, verbose_name='磁盘类型')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('floor', models.IntegerField(blank=True, default=0, null=True, verbose_name='楼层')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='repository.BusinessUnit', verbose_name='属于的业务线'),
        ),
        migrations.AddField(
            model_name='asset',
            name='idc',
            field=models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='repository.IDC', verbose_name='IDC机房'),
        ),
        migrations.AddField(
            model_name='asset',
            name='tag',
